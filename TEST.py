...
gmm0_ip = GaussianMixture(n_components=5, covariance_type='full', random_state=42).fit(dr0_ip).predict(dr0_ip)
...
plt.scatter(dr2_ip[:, 0], dr2_ip[:, 1], c=gmm2_ip, s=40, cmap='viridis')
plt.show()
...
# adjusting clust no.
c1_id['ip_cluster'] = c1_id['ip_cluster'] + 5
c2_id['ip_cluster'] = c2_id['ip_cluster'] + 7
c3_id['ip_cluster'] = c3_id['ip_cluster'] + 10
c4_id['ip_cluster'] = c4_id['ip_cluster'] + 13
